            ...
            <div class="relative slide-in-right">
                <div class="bg-gray-900/80 backdrop-blur-xl rounded-3xl border border-emerald-500/20 p-8 shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500">
                    ...
                    <div class="text-center bounce-in" style="animation-delay: 1.3s;">
                        ...
                        <a href="{{ route('register') }}" class="inline-flex items-center space-x-3 bg-gray-800/50 hover:bg-gray-700/50 text-cyan-300 hover:text-cyan-200 font-bold py-3 px-6 rounded-2xl transition-all duration-300 border border-cyan-500/30 hover:border-cyan-400/30 group">
                    ...
                    <div class="text-center mt-8 pt-6 border-t border-gray-700/50 bounce-in" style="animation-delay: 1.5s;">
                        ...
                        <a href="{{ url('/admin/login') }}" class="inline-flex items-center space-x-2 text-gray-500 hover:text-emerald-300 text-sm transition-colors group">

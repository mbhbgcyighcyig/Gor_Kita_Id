...
@section('title', 'Konfirmasi Booking - GotKita.ID')
                ...
                <div class="glass-card rounded-3xl p-8 border border-emerald-500/20">
                    ...
                    <div class="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-2xl p-6 border border-emerald-500/30 mb-8">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                <h2 class="text-2xl font-black text-white">{{ $field->name }}</h2>
                                <p class="text-gray-300">{{ $field->description ?? 'Lapangan premium berkualitas' }}</p>
                            ...
                            <div class="glass-card rounded-2xl p-4 border border-gray-700/50">
                                <div class="flex items-center space-x-3 mb-2">
                                    ...
                                    <div>
                                        ...
                                        @endphp
                                        <div class="text-white font-bold">{{ $startTime }}</div>
                                        @if($endTime)
                                        <div class="text-gray-300 text-sm">sampai {{ $endTime }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="glass-card rounded-2xl p-4 border border-gray-700/50">
                                <div class="flex items-center space-x-3 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-white font-bold">{{ $duration }} Jam</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="glass-card rounded-2xl p-4 border border-gray-700/50">
                                <div class="flex items-center space-x-3 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-white font-bold capitalize">{{ $field->type }}</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="sticky top-8 space-y-6">
                    ...
                    <div class="glass-card rounded-3xl p-6 border border-emerald-500/20">
                        ...
                        <div class="space-y-3 mb-4">
                            <div class="flex justify-between text-gray-300">
                                ...
                                <span>Rp {{ number_format($field->price_per_hour, 0, ',', '.') }}</span>
                            </div>
                            ...
                            @if($field->price_per_hour && $duration)
                            <div class="flex justify-between text-gray-300">
                                <span>Subtotal</span>
                                <span>Rp {{ number_format($field->price_per_hour * $duration, 0, ',', '.') }}</span>
                            </div>
                            @endif
                    ...
                    <div class="glass-card rounded-3xl p-6 border border-emerald-500/20">
                        ...
                        <form action="{{ route('booking.process') }}" method="POST" id="bookingForm">
                            ...
                            <input type="hidden" name="end_time" value="{{ $endTime ?? $startTime }}">

...
@section('title', 'Booking - Pilih Lapangan')
...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <!-- Futsal -->
  <!-- Futsal Card -->
<a href="{{ route('booking.select-field', 'futsal') }}" class="group">
...
<!-- Badminton Card -->
<a href="{{ route('booking.select-field', 'badminton') }}" class="group">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition">
...
<!-- Mini Soccer Card -->
<a href="{{ route('booking.select-field', 'mini_soccer') }}" class="group">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition">

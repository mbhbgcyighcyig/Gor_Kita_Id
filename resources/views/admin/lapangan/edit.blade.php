    ...
    <main class="ml-64 p-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <form action="{{ route('admin.lapangan.update', $field->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <select id="type" name="type" 
                            ...
                            <option value="minisoccer" {{ old('type', $field->type) == 'minisoccer' ? 'selected' : '' }}>Mini Soccer</option>
                        </select>
                        @error('type')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="price_per_hour" name="price_per_hour" value="{{ old('price_per_hour', $field->price_per_hour) }}" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"

                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_aplikasi" value="{{ $pengaturan->nama_aplikasi ?? 'GorKita.ID' }}" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Email Admin</label>
                                <input type="email" name="email_admin" value="{{ $pengaturan->email_admin ?? 'admin@gorkita.id' }}" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" name="batas_waktu_bayar" value="{{ $pengaturan->batas_waktu_bayar ?? 15 }}" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">PIN Demo</label>
                                <input type="text" name="pin_demo" value="{{ $pengaturan->pin_demo ?? '123456' }}" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Max Attempt PIN</label>
                                <input type="number" name="max_attempt_pin" value="{{ $pengaturan->max_attempt_pin ?? 3 }}" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <input type="number" name="harga_badminton" value="{{ $pengaturan->harga_badminton ?? 40000 }}" 
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <input type="number" name="harga_futsal" value="{{ $pengaturan->harga_futsal ?? 80000 }}" 
                                           class="w-full px-4 py-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                <input type="checkbox" name="notif_email" id="notif_email" 
                                       ...
                                       {{ ($pengaturan->notif_email ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="notif_booking_baru" id="notif_booking_baru" 
                                       class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded" 
                                       {{ ($pengaturan->notif_booking_baru ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="notif_pembayaran" id="notif_pembayaran" 
                                       class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded" 
                                       {{ ($pengaturan->notif_pembayaran ?? true) ? 'checked' : '' }}>

...
<?php $__env->startSection('title', 'Pembayaran - Booking #' . $booking->id); ?>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-yellow-300 text-2xl font-bold"><?php echo e($remainingTime); ?></p>
                    </div>
                </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                                ...
                                <p class="text-2xl font-black text-white"><?php echo e($booking->lapangan->nama_lapangan); ?></p>
                            </div>
                            <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                                <p class="text-gray-400 text-sm mb-2">Tanggal & Waktu</p>
                                <p class="text-xl font-bold text-white"><?php echo e($booking->formatted_date); ?></p>
                                <p class="text-lg text-emerald-300"><?php echo e($booking->formatted_time); ?></p>
                            </div>
                            <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                    ...
                    <form action="<?php echo e(route('booking.payment.process', $booking->id)); ?>" method="POST" id="paymentForm">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                                <?php $__currentLoopData = $vaNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank => $va): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative">
                                    <input type="radio" name="bank" value="<?php echo e($bank); ?>" 
                                           id="bank_<?php echo e($bank); ?>" class="hidden peer" required>
                                    <label for="bank_<?php echo e($bank); ?>" 
                                        ...
                                        <div class="bg-white/5 border-2 border-white/10 rounded-2xl p-6 text-center transition-all duration-300 
                                            ...
                                            <p class="font-bold text-white"><?php echo e($bank); ?></p>
                            ...
                            <div class="bg-white/5 rounded-2xl p-8 border border-white/10">
                                ...
                                <div class="bg-gradient-to-r from-red-500/10 to-pink-500/10 rounded-2xl p-4 mb-6 border border-red-500/30">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <p class="text-red-300 font-bold"><?php echo e(session('error')); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="space-y-4 mb-6">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-white font-bold">
                                    Rp <?php echo e(number_format($booking->lapangan->price_per_hour, 0, ',', '.')); ?>

                                </span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-400">Durasi</span>
                                <span class="text-white font-bold"><?php echo e($booking->duration); ?> jam</span>
                            </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/booking/payment.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title>Manajemen Pembayaran - SportSpace</title>
                ...
                <div class="stat-card bg-gradient-to-r from-yellow-500 to-orange-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($pendingVerification); ?></p>
                ...
                <div class="stat-card bg-gradient-to-r from-green-500 to-emerald-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($paidPayments); ?></p>
                ...
                <div class="stat-card bg-gradient-to-r from-red-500 to-pink-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($failedPayments + $expiredPayments); ?></p>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50 transition" 
                                data-status="<?php echo e($payment->payment_status); ?>"
                                data-search="<?php echo e(strtolower($payment->user->name . ' ' . $payment->lapangan->name . ' #' . $payment->id)); ?>">
                                <td class="py-4 px-6">
                                    <div class="font-bold text-gray-800">#<?php echo e($payment->id); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($payment->created_at->format('d/m/Y H:i')); ?></div>
                                </td>
                                <td class="py-4 px-6">
                                    <div class="font-bold text-gray-800"><?php echo e($payment->user->name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($payment->user->email); ?></div>
                                </td>
                                <td class="py-4 px-6">
                                    <div class="font-bold text-gray-800"><?php echo e($payment->lapangan->name ?? 'Court #' . $payment->lapangan_id); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($payment->lapangan->type ?? 'Tidak diketahui'); ?></div>
                                </td>
                                <td class="py-4 px-6">
                                    <div class="font-bold text-gray-800"><?php echo e(\Carbon\Carbon::parse($payment->tanggal_booking)->translatedFormat('d M Y')); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($payment->jam_mulai); ?> - <?php echo e($payment->jam_selesai); ?></div>
                                    <?php if($isExpired && in_array($payment->payment_status, ['pending_verification', 'pending'])): ?>
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex flex-col space-y-1">
                                        <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo e($statusClass); ?>">
                                            Payment: <?php echo e($payment->payment_status); ?>

                                        </span>
                                        <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo e($bookingStatusClass); ?>">
                                            Booking: <?php echo e($payment->status); ?>
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex space-x-2">
                                        <?php if($canConfirm && !$isExpired): ?>
                                        <!-- Konfirmasi Button -->
                                        <form action="<?php echo e(route('admin.confirmPayment', $payment->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <!-- Tolak Button -->
                                        <form action="<?php echo e(route('admin.rejectPayment', $payment->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <button type="submit" 
                                        ...
                                        <?php elseif($isExpired && in_array($payment->payment_status, ['pending_verification', 'pending'])): ?>
                                        <!-- Auto Expire Button -->
                                        <form action="<?php echo e(route('admin.rejectPayment', $payment->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <?php elseif(in_array($payment->status, ['expired', 'cancelled'])): ?>
                                            <span class="px-3 py-1 bg-gray-100 text-gray-800 rounded-lg text-sm">
                                                <?php if($payment->status == 'expired'): ?>
...
</html><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/admin/pembayaran.blade.php ENDPATH**/ ?>
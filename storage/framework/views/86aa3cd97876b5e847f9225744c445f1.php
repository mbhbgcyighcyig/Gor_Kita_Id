...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'GotKita.ID'); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-4 group">
                ...
                <div class="hidden lg:flex items-center space-x-1">
                    <a href="<?php echo e(route('home')); ?>" class="menu-item px-5 py-3 rounded-xl font-medium flex items-center space-x-2 hover:bg-white/10 transition-all duration-300">
                        <i class="fas fa-home text-sm"></i>
                        <span>Home</span>
                    </a>
                    
                    <a href="<?php echo e(route('about')); ?>" class="menu-item px-5 py-3 rounded-xl font-medium flex items-center space-x-2 hover:bg-white/10 transition-all duration-300">
                        <i class="fas fa-info-circle text-sm"></i>
                        <span>About</span>
                    </a>
                    
                    
                    <a href="<?php echo e(route('booking.select-field', ['type' => 'badminton'])); ?>" class="menu-item px-5 py-3 rounded-xl font-medium flex items-center space-x-2 hover:bg-white/10 transition-all duration-300 bg-white/5">
                        <i class="fas fa-calendar-alt text-sm"></i>
                        <span>Booking</span>
                    </a>
                    
                    <a href="<?php echo e(route('booking.my-bookings')); ?>" class="menu-item px-5 py-3 rounded-xl font-medium flex items-center space-x-2 hover:bg-white/10 transition-all duration-300">
                        <i class="fas fa-list text-sm"></i>
                        <span>My Bookings</span>
                    </a>
                    
                    <a href="<?php echo e(route('rating.index')); ?>" class="menu-item px-5 py-3 rounded-xl font-medium flex items-center space-x-2 hover:bg-white/10 transition-all duration-300">
                ...
                <div class="flex items-center space-x-4">
                    <?php if(session()->has('user_id')): ?>
                        <div class="flex items-center space-x-4">
                            <div class="user-badge px-4 py-2 rounded-xl flex items-center space-x-3">
                                ...
                                <div class="flex flex-col">
                                    <span class="font-medium"><?php echo e(session('user_name', 'User')); ?></span>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('user.login')); ?>" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-5 py-2.5 rounded-xl font-medium flex items-center space-x-2 shadow-lg hover:shadow-blue-500/30 transition-all duration-300">
            ...
            <div id="mobile-menu" class="hidden lg:hidden glassmorphism rounded-2xl mt-2 p-4 shadow-2xl animate-slideDown">
                <div class="flex flex-col space-y-2">
                    <a href="<?php echo e(route('home')); ?>" class="px-4 py-3 rounded-xl font-medium flex items-center space-x-3 hover:bg-white/10 transition-all duration-300">
                        <i class="fas fa-home text-emerald-300"></i>
                        <span>Home</span>
                    </a>
                    
                    <a href="<?php echo e(route('about')); ?>" class="px-4 py-3 rounded-xl font-medium flex items-center space-x-3 hover:bg-white/10 transition-all duration-300">
                        <i class="fas fa-info-circle text-emerald-300"></i>
                        <span>About</span>
                    </a>
                    
                    <!-- menu -->
                    <a href="<?php echo e(route('booking.select-field', ['type' => 'badminton'])); ?>" class="px-4 py-3 rounded-xl font-medium flex items-center space-x-3 hover:bg-white/10 transition-all duration-300 bg-white/5">
                        <i class="fas fa-calendar-alt text-emerald-300"></i>
                        <span>Booking</span>
                    </a>
                    
                    <a href="<?php echo e(route('booking.my-bookings')); ?>" class="px-4 py-3 rounded-xl font-medium flex items-center space-x-3 hover:bg-white/10 transition-all duration-300">
                        <i class="fas fa-list text-emerald-300"></i>
                        <span>My Bookings</span>
                    </a>
                    
                    <a href="<?php echo e(route('rating.index')); ?>" class="px-4 py-3 rounded-xl font-medium flex items-center space-x-3 hover:bg-white/10 transition-all duration-300">
                    ...
                    <?php if(session()->has('user_id')): ?>
                        <div class="border-t border-white/20 pt-4 mt-2">
                            <div class="px-4 py-3 rounded-xl bg-white/5 flex items-center space-x-3">
                                ...
                                <div class="flex-1">
                                    <div class="font-medium"><?php echo e(session('user_name', 'User')); ?></div>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('user.login')); ?>" class="px-4 py-3 rounded-xl font-medium flex items-center space-x-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white justify-center mt-4">
                            <i class="fas fa-sign-in-alt"></i>
                            <span>Login</span>
                        </a>
                    <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="space-y-3 text-gray-400">
                        <a href="<?php echo e(route('home')); ?>" class="block hover:text-emerald-400 transition-colors">
                            <i class="fas fa-chevron-right text-emerald-400 mr-2"></i>
                            Home
                        </a>
                        <a href="<?php echo e(route('booking.select-field', ['type' => 'badminton'])); ?>" class="block hover:text-emerald-400 transition-colors">
                            <i class="fas fa-chevron-right text-emerald-400 mr-2"></i>
                            Booking Lapangan
                        </a>
                        <a href="<?php echo e(route('booking.my-bookings')); ?>" class="block hover:text-emerald-400 transition-colors">
                            <i class="fas fa-chevron-right text-emerald-400 mr-2"></i>
                            Booking Saya
                        </a>
                        <a href="<?php echo e(route('rating.index')); ?>" class="block hover:text-emerald-400 transition-colors">
                            <i class="fas fa-chevron-right text-emerald-400 mr-2"></i>
                            Ulasan & Rating
                        </a>
                        <a href="<?php echo e(route('about')); ?>" class="block hover:text-emerald-400 transition-colors">
                            <i class="fas fa-chevron-right text-emerald-400 mr-2"></i>
                            Tentang Kami
                        </a>
                    </div>
                    ...
                    <div class="text-gray-400 mb-8">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="text-emerald-400"><?php echo e($jamBuka); ?> - <?php echo e($jamTutup); ?></span>
                            </div>
            ...
            <div class="border-t border-gray-700 mt-12 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <p class="text-gray-500 mb-4 md:mb-0">
                        &copy; <?php echo e(date('Y')); ?> <span class="text-emerald-300 font-semibold">GotKita.ID</span> - All rights reserved.
                    </p>
...
</html><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/layout.blade.php ENDPATH**/ ?>
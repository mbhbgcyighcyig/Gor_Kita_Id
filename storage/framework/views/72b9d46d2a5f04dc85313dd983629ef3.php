                ...
                <div class="stat-card bg-gradient-to-r from-blue-500 to-cyan-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($totalBookings); ?></p>
                ...
                <div class="stat-card bg-gradient-to-r from-green-500 to-emerald-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($todayBookings); ?></p>
                            <p class="text-sm opacity-80 mt-2"><?php echo e(\Carbon\Carbon::now()->format('d M Y')); ?></p>
                        </div>
                        <div class="bg-white bg-opacity-20 rounded-full p-4">
                ...
                <div class="stat-card bg-gradient-to-r from-yellow-500 to-orange-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($pendingBookings); ?></p>
                ...
                <div class="stat-card bg-gradient-to-r from-purple-500 to-pink-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($confirmedBookings); ?></p>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50 transition">
                                <td class="py-4 px-6">
                                    <div class="font-bold text-gray-800">#<?php echo e($booking->id); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($booking->created_at->format('d/m/Y H:i')); ?></div>
                                </td>
                                <td class="py-4 px-6">
                                ...
                                <td class="py-4 px-6">
                                    <!-- ✅ PERBAIKAN: 'field' -> 'lapangan' -->
                                    <?php if($booking->lapangan): ?>
                                        <p class="font-bold text-gray-800"><?php echo e($booking->lapangan->name); ?></p>
                                        <p class="text-gray-500 text-sm capitalize"><?php echo e($booking->lapangan->type ?? 'Tidak diketahui'); ?></p>
                                        <p class="text-xs text-gray-400">Rp <?php echo e(number_format($booking->lapangan->price_per_hour, 0, ',', '.')); ?>/jam</p>
                                    <?php else: ?>
                                        <p class="font-bold text-gray-800">Court #<?php echo e($booking->lapangan_id); ?></p>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        <?php echo e($booking->jam_mulai); ?> - <?php echo e($booking->jam_selesai); ?>
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex space-x-2">
                                        ...
                                        <form action="<?php echo e(route('admin.bookings.complete', $booking->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" 
...
</html><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/admin/book.blade.php ENDPATH**/ ?>
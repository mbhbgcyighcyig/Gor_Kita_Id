...
<?php $__env->startSection('title', 'Pilih Waktu Booking - ' . $field->name); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-black py-8">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 border border-emerald-500/20 backdrop-blur-sm">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-black text-white"><?php echo e($field->name); ?></h3>
                                    <p class="text-emerald-300 text-sm font-semibold capitalize"><?php echo e($field->type); ?></p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-700/50">
                            <div class="text-center">
                                ...
                                <div class="text-white font-semibold"><?php echo e($field->capacity ?? 'Standar'); ?></div>
                            </div>
                            <div class="text-center">
                                <div class="text-gray-400 text-sm mb-1">Ukuran</div>
                                <div class="text-white font-semibold"><?php echo e($field->size ?? 'Standar'); ?></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-cyan-300 font-semibold text-sm">
                                    <?php echo e(\Carbon\Carbon::parse($selectedDate)->translatedFormat('d M Y')); ?>

                                </p>
                            </div>
                        </div>

                        <form action="<?php echo e(route('booking.select-time', $field->id)); ?>" method="GET" class="space-y-4">
                            <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="text-emerald-300 font-semibold"><?php echo e(number_format($availabilityPercent, 0)); ?>%</span>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-4 text-center">
                                <div>
                                    <div class="text-2xl font-black text-emerald-300"><?php echo e($availableCount); ?></div>
                                    <div class="text-gray-400 text-xs">Tersedia</div>
                                </div>
                                <div>
                                    <div class="text-2xl font-black text-red-300"><?php echo e($bookedCount); ?></div>
                                    <div class="text-gray-400 text-xs">Dipesan</div>
                                </div>
                                <div>
                                    <div class="text-2xl font-black text-gray-400"><?php echo e($expiredCount); ?></div>
                            ...
                            <div class="pt-4 border-t border-gray-700/50">
                                <div class="text-xs text-gray-500 space-y-1">
                                    <div class="flex items-center">
                                        ...
                                        <span>Waktu WIB: <span id="currentTimeWIB"><?php echo e($nowWIB->format('H:i:s')); ?></span></span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-calendar mr-2"></i>
                                        <span>Status: <?php echo e($isToday ? 'HARI INI' : 'BUKAN HARI INI'); ?></span>
                                    </div>
                                    <?php if($isToday): ?>
            ...
            <!-- Time Selection Area -->
            <div class="lg:w-2/3">
                <?php if(count($availableSlots['available']) > 0): ?>
                    <!-- Time Slots Grid -->
                    <div class="bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-8 border border-emerald-500/20 backdrop-blur-sm">
                        ...
                        <div class="flex items-center justify-between mb-8">
                            ...
                            <div class="text-right">
                                ...
                                <div class="text-xl font-black text-emerald-300"><?php echo e($availableCount); ?> slot</div>
                            </div>
                        </div>

                        <!-- Time Slots Grid - LOGIKA SIMPLE -->
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                            <?php $__currentLoopData = $availableSlots['all']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <?php if($isAvailable): ?>
                                    <a href="<?php echo e(route('booking.confirm', $field->id)); ?>?date=<?php echo e($selectedDate); ?>&time=<?php echo e($timeSlot); ?>" 
                                ...
                                <?php else: ?>
                                    <div class="relative bg-gradient-to-br 
                                        <?php if($isBooked): ?> from-red-500/10 to-red-600/10 border-red-500/30
                                        <?php elseif($isExpired): ?> from-gray-600/10 to-gray-700/10 border-gray-500/30
                                        <?php else: ?> from-gray-500/10 to-gray-600/10 border-gray-400/30 <?php endif; ?>
                                        rounded-2xl p-4 border-2 opacity-70 cursor-not-allowed"
                                        title="<?php if($isBooked): ?> Sudah dipesan <?php elseif($isExpired): ?> Waktu sudah lewat <?php endif; ?>">
                                <?php endif; ?>
                                
                                    <!-- Time -->
                                    <div class="text-center mb-2">
                                        <div class="text-lg font-black <?php if($isAvailable): ?> text-white group-hover:text-emerald-300 transition-colors <?php elseif($isBooked): ?> text-red-200 <?php else: ?> text-gray-400 <?php endif; ?>">
                                            <?php echo e($timeSlot); ?>

                                        </div>
                                        <div class="text-xs <?php if($isAvailable): ?> text-gray-400 <?php elseif($isBooked): ?> text-red-300/70 <?php else: ?> text-gray-500 <?php endif; ?>">
                                            1 jam
                                            <?php if($isExpired): ?>
                                    ...
                                    <div class="text-center">
                                        <div class="text-sm font-semibold 
                                            <?php if($isAvailable): ?> text-emerald-300 
                                            <?php elseif($isBooked): ?> text-red-300/70 
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-700/50">
                            <div class="flex flex-wrap items-center justify-center gap-4 text-sm">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-gray-300">WIB: <span id="currentTimeWIB2"><?php echo e($nowWIB->format('H:i')); ?></span></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-700/50">
                            <div class="flex flex-col sm:flex-row gap-4 justify-between items-center">
                                ...
                                <a href="<?php echo e(route('booking.select-field', $field->type)); ?>" 
                ...
                <?php else: ?>
                    ...
                    <div class="bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-12 border border-emerald-500/20 backdrop-blur-sm text-center">
                        ...
                        <p class="text-gray-400 mb-8 max-w-md mx-auto leading-relaxed">
                            <?php if(count($availableSlots['expired']) > 0): ?>
                                Semua slot waktu untuk tanggal <?php echo e(\Carbon\Carbon::parse($selectedDate)->translatedFormat('l, d F Y')); ?> sudah lewat.
                            <?php else: ?>
                                Semua jam pada tanggal <?php echo e(\Carbon\Carbon::parse($selectedDate)->translatedFormat('l, d F Y')); ?> telah dipesan.
                            <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const selectedDate = "<?php echo e($selectedDate); ?>";
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/booking/select-time.blade.php ENDPATH**/ ?>
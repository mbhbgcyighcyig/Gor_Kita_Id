                ...
                <div class="stat-card bg-gradient-to-r from-purple-500 to-pink-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm opacity-80 mt-2">Rata²: Rp <?php echo e(number_format($avgRevenue, 0, ',', '.')); ?></p>
                        </div>
                        <div class="bg-white bg-opacity-20 rounded-full p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                <div class="chart-container">
                    ...
                    <div class="space-y-4">
                        ...
                        <?php $__currentLoopData = $topFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-bold text-gray-800"><?php echo e($field->name); ?></p>
                                    <p class="text-sm text-gray-600"><?php echo e($field->type); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-bold text-blue-600"><?php echo e($field->bookings_count); ?></p>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-50 transition">
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="text-gray-800"><?php echo e(\Carbon\Carbon::parse($booking->tanggal_booking)->format('d/m/Y')); ?></div>
                                        <div class="text-sm text-gray-500"><?php echo e($booking->jam_mulai); ?></div>
                                    </td>
                                    <td class="py-3 px-4">
...
</html><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/admin/laporan.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Pembayaran Berhasil - Booking #' . $booking->id); ?>
                ...
                <div class="space-y-8 relative">
                    ...
                    <div class="flex items-start space-x-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-emerald-300 text-sm mt-1">
                                <?php echo e($paymentData['date'] ?? now()->format('d M Y, H:i')); ?>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                            <div class="flex items-center space-x-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-3xl font-black text-white">#<?php echo e($booking->id); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                            ...
                            <p class="text-2xl font-black text-white flex items-center">
                                ...
                                <?php echo e($booking->lapangan->name ?? 'Lapangan'); ?>
                        ...
                        <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                            <div class="flex justify-between items-center mb-4">
                                <div>
                                    ...
                                    <p class="text-2xl font-black text-white"><?php echo e($booking->duration); ?> jam</p>
                                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="text-xl font-black text-white"><?php echo e($paymentData['bank'] ?? 'BCA'); ?></p>
                        ...
                        <div class="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-2xl p-6 border border-emerald-500/30">
                            ...
                            <div class="flex items-center justify-between">
                                <code class="text-2xl font-black tracking-wider text-white bg-black/50 px-4 py-3 rounded-xl">
                                    <?php echo e($paymentData['va_number'] ?? '888' . str_pad($booking->id, 12, '0', STR_PAD_LEFT)); ?>
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <div class="w-12 h-12 bg-gradient-to-br from-red-500/20 to-pink-500/20 rounded-xl flex items-center justify-center border border-red-400/30">
                                        <span class="text-white font-bold text-xl">
                                            <?php echo e(str_split($paymentData['pin'] ?? '123456')[$i] ?? '●'); ?>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white/5 rounded-2xl p-4 border border-white/10">
                                ...
                                <p class="text-white font-bold"><?php echo e($paymentData['date'] ?? now()->format('d/m/Y H:i:s')); ?></p>
                            </div>
                                        ...
                                        <div class="bg-white p-4 rounded-2xl inline-block border-2 border-emerald-500/30">
                                            <div class="w-40 h-40 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center border border-gray-300">
                                                <div class="text-center">
                                                    ...
                                                    <div class="text-xs text-gray-500">#<?php echo e($booking->id); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
function copyVA() {
    const vaNumber = '<?php echo e($paymentData['va_number'] ?? '888' . str_pad($booking->id, 12, '0', STR_PAD_LEFT)); ?>';

...
<?php $__env->startSection('title', 'Bukti Pembayaran - Booking #' . $booking->id); ?>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 p-8 mb-8" id="receipt">
            <div id="receipt-content">
                <div class="text-center mb-8 border-b pb-6">
                    ...
                    <p class="text-gray-400 text-sm mt-2"><?php echo e(now()->format('d F Y, H:i:s')); ?></p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="border p-4 rounded-lg">
                        ...
                        <p class="font-bold text-gray-800 text-lg">#<?php echo e($booking->id); ?></p>
                    </div>
                    <div class="border p-4 rounded-lg">
                        <p class="text-sm text-gray-500 mb-1">Tanggal Booking</p>
                        <p class="font-bold text-gray-800"><?php echo e(\Carbon\Carbon::parse($booking->tanggal_booking)->format('d/m/Y')); ?></p>
                    </div>
                    <div class="col-span-2 border p-4 rounded-lg">
                        <p class="text-sm text-gray-500 mb-1">Lapangan</p>
                        <p class="font-bold text-gray-800 text-lg"><?php echo e($booking->lapangan->name ?? 'Lapangan'); ?></p>
                        <p class="text-gray-600 text-sm"><?php echo e($booking->lapangan->type ?? 'Lapangan Olahraga'); ?></p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="border p-4 rounded-lg">
                        ...
                        <p class="font-bold text-gray-800"><?php echo e($booking->jam_mulai); ?> - <?php echo e($booking->jam_selesai); ?></p>
                    </div>
                    <div class="border p-4 rounded-lg">
                        <p class="text-sm text-gray-500 mb-1">Durasi</p>
                        <p class="font-bold text-gray-800"><?php echo e($booking->duration); ?> jam</p>
                    </div>
                </div>
                ...
                <div class="border rounded-lg p-4 mb-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold"><?php echo e($paymentData['bank'] ?? 'BCA Virtual Account'); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Virtual Account</span>
                            <span class="font-bold font-mono"><?php echo e($paymentData['va_number'] ?? '888' . str_pad($booking->id, 12, '0', STR_PAD_LEFT)); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Waktu Pembayaran</span>
                            <span class="font-bold"><?php echo e($paymentData['date'] ?? now()->format('d/m/Y H:i:s')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="border rounded-lg p-4 mb-6 text-center">
                    ...
                    <div class="flex justify-center space-x-3 mb-3">
                        ...
                        ?>
                        <?php $__currentLoopData = $pinDigits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $digit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
function printReceipt() {
    ...
    printWindow.document.write(`
        ...
        <html>
        <head>
            <title>Bukti Pembayaran #<?php echo e($booking->id); ?> - GorKita.ID</title>
            <style>
        ...
        <body>
            <div class="print-header">
                <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 10px;">
                    ...
                    <div>
                        ...
                        <div class="print-subtitle">GorKita.ID - <?php echo e(now()->format('d F Y, H:i:s')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="print-section">
                ...
                <div class="print-grid">
                    <div class="print-box">
                        ...
                        <div class="print-value">#<?php echo e($booking->id); ?></div>
                    </div>
                    <div class="print-box">
                        <div class="print-label">Booking Date</div>
                        <div class="print-value"><?php echo e(\Carbon\Carbon::parse($booking->tanggal_booking)->format('d/m/Y')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="print-section">
                <div class="print-box">
                    ...
                    <div class="print-value" style="font-size: 18px;"><?php echo e($booking->lapangan->name ?? 'Lapangan'); ?></div>
                    <div style="color: #6b7280; font-size: 14px;"><?php echo e($booking->lapangan->type ?? 'Lapangan Olahraga'); ?></div>
                </div>
            </div>
            ...
            <div class="print-section">
                <div class="print-grid">
                    <div class="print-box">
                        ...
                        <div class="print-value"><?php echo e($booking->jam_mulai); ?> - <?php echo e($booking->jam_selesai); ?></div>
                    </div>
                    <div class="print-box">
                        <div class="print-label">Duration</div>
                        <div class="print-value"><?php echo e($booking->duration); ?> jam</div>
                    </div>
                </div>
            </div>
                ...
                <div class="print-box">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="padding: 8px 0; border-bottom: 1px solid #e5e7eb; text-align: right; font-weight: 600;"><?php echo e($paymentData['bank'] ?? 'BCA Virtual Account'); ?></td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; border-bottom: 1px solid #e5e7eb;">Virtual Account</td>
                            <td style="padding: 8px 0; border-bottom: 1px solid #e5e7eb; text-align: right; font-family: monospace; font-weight: 600;"><?php echo e($paymentData['va_number'] ?? '888' . str_pad($booking->id, 12, '0', STR_PAD_LEFT)); ?></td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0;">Payment Time</td>
                            <td style="padding: 8px 0; text-align: right; font-weight: 600;"><?php echo e($paymentData['date'] ?? now()->format('d/m/Y H:i:s')); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="print-amount">
                ...
                <div class="print-amount-value">Rp <?php echo e(number_format($booking->total_price, 0, ',', '.')); ?></div>
            ...
            <div class="print-section">
                ...
                <div class="print-verification">
                    ...
                    <div class="print-pin">
                        ...
                        ?>
                        <?php $__currentLoopData = $pinDigits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $digit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pin-digit"><?php echo e($digit); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="print-footer">
                ...
                <div style="font-size: 11px; color: #9ca3af;">
                    ...
                    <div>GorKita.ID © <?php echo e(date('Y')); ?> - All rights reserved</div>
                </div>
            </div>
...
async function downloadAsPDF() {
    ...
    try {
        ...
        // pdf
        pdf.save(`bukti-pembayaran-<?php echo e($booking->id); ?>-<?php echo e(date('YmdHis')); ?>.pdf`);
...
async function downloadAsImage() {
    ...
    try {
        ...
        link.download = `bukti-pembayaran-<?php echo e($booking->id); ?>-<?php echo e(date('YmdHis')); ?>.jpg`;
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/booking/payment-success.blade.php ENDPATH**/ ?>
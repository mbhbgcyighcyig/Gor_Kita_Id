                ...
                <div class="stat-card bg-gradient-to-r from-purple-500 to-pink-500 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold">Rp <?php echo e(number_format($weeklyRevenue, 0, ',', '.')); ?></p>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">
                                            <?php echo e($booking->lapangan->name ?? 'Court #' . $booking->lapangan_id); ?> • <?php echo e($booking->jam_mulai); ?> - <?php echo e($booking->jam_selesai); ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-white border rounded-lg hover:shadow-md transition">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-800"><?php echo e($booking->user->name); ?></p>
                                    <p class="text-sm text-gray-600">
                                        <?php echo e($booking->lapangan->name ?? 'Court #' . $booking->lapangan_id); ?> - <?php echo e(\Carbon\Carbon::parse($booking->tanggal_booking)->format('d M Y')); ?>

                                    </p>
                                    <p class="text-xs text-gray-500"><?php echo e($booking->jam_mulai); ?> - <?php echo e($booking->jam_selesai); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
                ...
                <div class="chart-container">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-blue-50 p-4 rounded-lg text-center">
                            ...
                            <p class="font-bold text-gray-800"><?php echo e(\App\Models\User::count()); ?></p>
                            <p class="text-sm text-gray-600">Total Users</p>
                        </div>
                        <div class="bg-green-50 p-4 rounded-lg text-center">
                            <i class="fas fa-map-marker-alt text-green-600 text-2xl mb-2"></i>
                            <p class="font-bold text-gray-800"><?php echo e(\App\Models\Lapangan::count()); ?></p> <!-- ✅ PERBAIKI: Lapangan bukan Field -->
                            <p class="text-sm text-gray-600">Total Lapangan</p>
                        </div>
                        <div class="bg-purple-50 p-4 rounded-lg text-center">
                            <i class="fas fa-check-circle text-purple-600 text-2xl mb-2"></i>
                            <p class="font-bold text-gray-800"><?php echo e(\App\Models\Booking::where('status', 'confirmed')->count()); ?></p>
                            <p class="text-sm text-gray-600">Confirmed</p>
                        </div>
                        <div class="bg-yellow-50 p-4 rounded-lg text-center">
                            <i class="fas fa-clock text-yellow-600 text-2xl mb-2"></i>
                            <p class="font-bold text-gray-800"><?php echo e(\App\Models\Booking::where('status', 'pending')->count()); ?></p>
            ...
            const weeklyChart = new Chart(ctx, {
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            beginAtZero: true,
                            suggestedMax: <?php echo e($maxValue + 1); ?>,
                            grid: {
...
</html><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
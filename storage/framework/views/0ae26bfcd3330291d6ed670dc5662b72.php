            ...
            <div class="bg-gradient-to-br from-emerald-500/10 to-green-500/10 rounded-2xl p-6 border border-emerald-500/30 mb-6">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <div class="text-gray-300">Pembayaran berhasil via <?php echo e(strtoupper($booking->payment_method ?? 'Transfer')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 rounded-2xl p-6 border border-yellow-500/30 mb-6">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <div class="text-gray-300">Menunggu konfirmasi pembayaran via <?php echo e(strtoupper($booking->payment_method ?? 'Transfer')); ?></div>
                    </div>
                </div>
            </div>
            <?php endif; ?>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <div class="text-white font-bold text-lg">
                                    <?php echo e(\Carbon\Carbon::parse($booking->tanggal_booking)->format('d M Y')); ?>

                                </div>
                                <div class="text-gray-400 text-sm"><?php echo e(\Carbon\Carbon::parse($booking->tanggal_booking)->format('l')); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/5 rounded-2xl p-4 border border-gray-700/50">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <div class="text-white font-bold text-lg">
                                    <?php echo e(\Carbon\Carbon::parse($booking->jam_mulai)->format('H:i')); ?> - <?php echo e(\Carbon\Carbon::parse($booking->jam_selesai)->format('H:i')); ?>
                    ...
                    <div class="bg-white/5 rounded-2xl p-4 border border-gray-700/50">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <?php if($booking->field): ?>
                                    <div class="text-white font-bold text-lg"><?php echo e($booking->field->name); ?></div>
                                    <div class="text-gray-400 text-sm"><?php echo e($booking->field->description ?? 'Tidak ada deskripsi'); ?></div>
                                <?php else: ?>
                                    <div class="text-white font-bold text-lg">Lapangan #<?php echo e($booking->lapangan_id); ?></div>
                    ...
                    <div class="bg-white/5 rounded-2xl p-4 border border-gray-700/50">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <div class="text-white font-bold text-lg capitalize"><?php echo e($booking->status ?? 'pending'); ?></div>
                                <div class="text-gray-400 text-sm">
                                    <?php if(isset($booking->total_price) && $booking->total_price > 0): ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/booking/success.blade.php ENDPATH**/ ?>
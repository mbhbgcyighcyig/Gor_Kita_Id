                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_aplikasi" value="<?php echo e($pengaturan->nama_aplikasi); ?>" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Email Admin</label>
                                <input type="email" name="email_admin" value="<?php echo e($pengaturan->email_admin); ?>" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
                                ...
                                <input type="time" name="jam_buka" value="<?php echo e($pengaturan->jam_buka); ?>" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                            <span class="mt-6 text-gray-500">s/d</span>
                            <div class="flex-1">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Jam Tutup</label>
                                <input type="time" name="jam_tutup" value="<?php echo e($pengaturan->jam_tutup); ?>" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="payment_gateway" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="midtrans" <?php echo e($pengaturan->payment_gateway == 'midtrans' ? 'selected' : ''); ?>>Midtrans</option>
                                    <option value="xendit" <?php echo e($pengaturan->payment_gateway == 'xendit' ? 'selected' : ''); ?>>Xendit</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">API Key</label>
                                <input type="text" name="api_key" value="<?php echo e($pengaturan->api_key); ?>" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <?php if($pengaturan->logo): ?>
                                <p class="text-sm text-gray-500 mt-2">Logo saat ini: <?php echo e($pengaturan->logo); ?></p>
                                <img src="<?php echo e(Storage::url($pengaturan->logo)); ?>" alt="Logo" class="mt-2 h-20">
                            <?php else: ?>

...
<?php $__env->startSection('title', 'Dashboard - GotKita.ID'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-black">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex justify-center mb-6">
            <img src="<?php echo e(asset('img/logo/logo-gorkita.png')); ?>" 
                 alt="GorKita.ID Logo" 
        ...
        <div class="text-center mb-10">
            <div class="inline-flex items-center space-x-3 bg-white/5 backdrop-blur-xl border border-emerald-500/20 rounded-2xl px-6 py-3 mb-6">
                ...
                <span class="text-sm font-bold tracking-wider text-emerald-200">
                    <?php echo e(session()->has('user_id') ? 'Hallo Pejuang' : 'Welcome to GorKita.ID'); ?>
            ...
            <h1 class="text-4xl lg:text-5xl font-black text-white mb-4 leading-tight">
                Hello, <span class="bg-gradient-to-r from-emerald-300 to-cyan-400 bg-clip-text text-transparent">
                    <?php echo e(session()->has('user_name') ? session('user_name') : 'Guest'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div class="group bg-gradient-to-br from-emerald-600/20 to-cyan-600/20 rounded-3xl p-6 shadow-2xl border border-emerald-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-2">
                ...
                <p class="text-4xl font-black text-emerald-300 mb-2"><?php echo e($stats['total_bookings']); ?></p>
            ...
            <div class="group bg-gradient-to-br from-cyan-600/20 to-emerald-600/20 rounded-3xl p-6 shadow-2xl border border-cyan-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-2">
                ...
                <p class="text-4xl font-black text-cyan-300 mb-2"><?php echo e($stats['active_bookings']); ?></p>
            ...
            <div class="group bg-gradient-to-br from-emerald-600/20 to-cyan-600/20 rounded-3xl p-6 shadow-2xl border border-emerald-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-2">
                ...
                <p class="text-4xl font-black text-emerald-300 mb-2"><?php echo e($stats['completed_bookings']); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-emerald-500/20 backdrop-blur-sm">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="<?php echo e(route('rating.index')); ?>" class="text-emerald-300 hover:text-cyan-300 text-sm font-semibold flex items-center space-x-2 transition-colors">
                ...
                <div class="space-y-4">
                    <?php $__currentLoopData = $joniRatings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group bg-white/5 rounded-2xl p-4 border border-white/10 hover:border-emerald-500/30 transition-all duration-300 backdrop-blur-sm">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <!-- AVATAR USER -->
                                <img src="<?php echo e(asset('img/users/default-avatar.png')); ?>" 
                                     alt="Joni"
                                     class="w-12 h-12 rounded-2xl object-cover border border-emerald-400/30"
                                     onerror="this.src='<?php echo e(asset('img/users/default-avatar.png')); ?>'">
                                <div>
                            ...
                            <span class="text-gray-500 text-sm"><?php echo e($rating['time']); ?></span>
                        </div>
                        <?php if(!empty($rating['comment'])): ?>
                            <p class="text-gray-300 mt-3 text-sm leading-relaxed"><?php echo e($rating['comment']); ?></p>
                        <?php endif; ?>
                    </div>
            ...
            <div class="bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-cyan-500/20 backdrop-blur-sm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <a href="<?php echo e(route('booking.select-field', ['type' => 'badminton'])); ?>" class="group bg-gradient-to-br from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 text-white p-5 rounded-2xl text-center transition-all duration-300 transform hover:-translate-y-2 border border-emerald-500/30 backdrop-blur-sm">
                    ...
                    <a href="<?php echo e(route('booking.my-bookings')); ?>" class="group bg-gradient-to-br from-cyan-600 to-emerald-600 hover:from-cyan-500 hover:to-emerald-500 text-white p-5 rounded-2xl text-center transition-all duration-300 transform hover:-translate-y-2 border border-cyan-500/30 backdrop-blur-sm">
                    ...
                    <a href="<?php echo e(route('rating.index')); ?>" class="group bg-gradient-to-br from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 text-white p-5 rounded-2xl text-center transition-all duration-300 transform hover:-translate-y-2 border border-emerald-500/30 backdrop-blur-sm">
                    ...
                    <a href="<?php echo e(route('about')); ?>" class="group bg-gradient-to-br from-cyan-600 to-emerald-600 hover:from-cyan-500 hover:to-emerald-500 text-white p-5 rounded-2xl text-center transition-all duration-300 transform hover:-translate-y-2 border border-cyan-500/30 backdrop-blur-sm">
        ...
        <div class="mt-12">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $futsalFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-emerald-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-3">
                        <div class="relative mb-5 overflow-hidden rounded-2xl">
                            ...
                            ?>
                            <img src="<?php echo e($field->image_url ?: $localFutsalImage); ?>" 
                            ...
                            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                                <h4 class="text-xl font-black text-white"><?php echo e($field->name); ?></h4>
                            </div>
                        </div>
                        <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-700/50">
                            <div>
                                <span class="text-2xl font-black text-emerald-300">Rp <?php echo e(number_format($field->price_per_hour ?? 150000, 0, ',', '.')); ?></span>
                    ...
                    ?>
                    <?php $__currentLoopData = $localDummyFutsalFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dummyField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-emerald-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-3">
                        <div class="relative mb-5 overflow-hidden rounded-2xl">
                            <img src="<?php echo e($dummyField['image']); ?>" 
                                 alt="<?php echo e($dummyField['name']); ?>"
                                 class="w-full h-48 object-cover transition duration-500 group-hover:scale-110">
                            <div class="absolute top-3 right-3 bg-gradient-to-r from-emerald-500 to-cyan-500 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                                Available
                            </div>
                            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                                <h4 class="text-xl font-black text-white"><?php echo e($dummyField['name']); ?></h4>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div class="flex items-center space-x-2 text-gray-300">
                                <i class="fas fa-ruler-combined text-emerald-400 text-sm"></i>
                                <span class="text-sm">Size: <?php echo e($dummyField['size']); ?></span>
                            </div>
                            <div class="flex items-center space-x-2 text-gray-300">
                                <i class="fas fa-bolt text-cyan-400 text-sm"></i>
                                <span class="text-sm">pencahayaan yang berkualitas</span>
                        ...
                        <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-700/50">
                            <div>
                                <span class="text-2xl font-black text-emerald-300">Rp <?php echo e(number_format($dummyField['price'], 0, ',', '.')); ?></span>
                                <span class="text-gray-400 text-sm">/jam</span>
                            </div>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $badmintonFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-cyan-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-3">
                        <div class="relative mb-5 overflow-hidden rounded-2xl">
                            ...
                            ?>
                            <img src="<?php echo e($field->image_url ?: $localBadmintonImage); ?>" 
                                 alt="<?php echo e($field->name); ?>"
                                 class="w-full h-48 object-cover transition duration-500 group-hover:scale-110"
                                 onerror="this.src='<?php echo e(asset('img/fields/default-field.jpg')); ?>'">
                        ...
                        <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-700/50">
                            <div>
                                <span class="text-2xl font-black text-cyan-300">Rp <?php echo e(number_format($field->price_per_hour ?? 100000, 0, ',', '.')); ?></span>
                                <span class="text-gray-400 text-sm">/jam</span>
                            </div>
                    ...
                    ?>
                    <?php $__currentLoopData = $localDummyBadmintonFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dummyField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-cyan-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-3">
                        <div class="relative mb-5 overflow-hidden rounded-2xl">
                            <img src="<?php echo e($dummyField['image']); ?>" 
                                 alt="<?php echo e($dummyField['name']); ?>"
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-2 text-gray-300">
                                <i class="fas fa-table-tennis-paddle-ball text-cyan-400 text-sm"></i>
                                <span class="text-sm">Type: <?php echo e($dummyField['type']); ?></span>
                            </div>
                            <div class="flex items-center space-x-2 text-gray-300">
                                <i class="fas fa-floor text-emerald-400 text-sm"></i>
                        ...
                        <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-700/50">
                            <div>
                                <span class="text-2xl font-black text-cyan-300">Rp <?php echo e(number_format($dummyField['price'], 0, ',', '.')); ?></span>
                                <span class="text-gray-400 text-sm">/jam</span>
                            </div>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $miniSoccerFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-emerald-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-3">
                        <div class="relative mb-5 overflow-hidden rounded-2xl">
                            ...
                            ?>
                            <img src="<?php echo e($field->image_url ?: $localSoccerImage); ?>" 
                                 alt="<?php echo e($field->name); ?>"
                                 class="w-full h-48 object-cover transition duration-500 group-hover:scale-110"
                                 onerror="this.src='<?php echo e(asset('img/fields/default-field.jpg')); ?>'">
                            <div class="absolute top-3 right-3 bg-gradient-to-r from-emerald-500 to-cyan-500 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-2 text-gray-300">
                                ...
                                <span class="text-sm">Capacity: <?php echo e($field->capacity ?? '7v7'); ?></span>
                            </div>
                            <div class="flex items-center space-x-2 text-gray-300">
                        ...
                        <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-700/50">
                            <div>
                                <span class="text-2xl font-black text-emerald-300">Rp <?php echo e(number_format($field->price_per_hour ?? 200000, 0, ',', '.')); ?></span>
                    ...
                    ?>
                    <?php $__currentLoopData = $localDummySoccerFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dummyField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-6 shadow-2xl border border-emerald-500/20 backdrop-blur-sm transition-all duration-500 transform hover:-translate-y-3">
                        <div class="relative mb-5 overflow-hidden rounded-2xl">
                            <img src="<?php echo e($dummyField['image']); ?>" 
                                 alt="<?php echo e($dummyField['name']); ?>"
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-2 text-gray-300">
                                <i class="fas fa-expand text-emerald-400 text-sm"></i>
                                <span class="text-sm">Capacity: <?php echo e($dummyField['capacity']); ?></span>
                            </div>
                            <div class="flex items-center space-x-2 text-gray-300">
                                <i class="fas fa-grass text-cyan-400 text-sm"></i>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gor_Kita_Id\resources\views/home.blade.php ENDPATH**/ ?>